import { LayoutDashboard, ShoppingCart, Package, Receipt, BarChart3, Settings, LogOut, Users, RefreshCw, Crown, PieChart, ClipboardList, Sparkles, Truck } from 'lucide-react';
...
const navItems: { id: ViewType; label: string; icon: React.ElementType; requiresAdmin?: boolean }[] = [
  ...
  { id: 'suppliers', label: 'Suppliers', icon: Truck, requiresAdmin: true },
  { id: 'ai-recommendations', label: 'AI Insights', icon: Sparkles, requiresAdmin: true },
  { id: 'reports', label: 'Reports', icon: BarChart3 },
];

export function Sidebar({ currentView, onViewChange, profile, roles, onSignOut }: SidebarProps) {
